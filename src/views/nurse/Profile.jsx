...
const NurseProfile = () => {
  ...
  const fetchProfile = async () => {
    try {
      setLoading(true);
      const resp = await Get(apiEndpoints.nurse.getProfile);
  ...
  const updateNurse = async (e) => {
    ...
    try {
      ...
      const resp = await Put(apiEndpoints.nurse.updateProfile, params);
      //console.log("resp:::", resp);
      const respObj = {};
      if (resp.success) {
      ...
      <div className="row">
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <label className="form-control">{profile?.nur_email}</label>
          </div>
          <div className="mb-3">
        ...
        <div className="col-md-6">
          ...
          {/* <div className="mb-3">
            <label className="form-label">Attachted Doctors:</label>
...
//
const UpdateProfileView = ({isLoading , formData, setFormData , handleChange , updateNurse , showResp , setShowResp , onCloseModal}) => {
  //
  return (
    <Modal
      title={"Update Nurse"}
      body={
        <form onSubmit={updateNurse} className="row">
          <ErrorAlert
